...
const Main = () => {
  ...
  const [imgObj0, updateImgObj0] = useState({
    img: images[0].img,
    id: images[0].id,
  });
  imgObjs.push(imgObj0);
  const [imgObj1, updateImgObj1] = useState({
    img: images[1].img,
    id: images[1].id,
  });
  imgObjs.push(imgObj1);
  const [imgObj2, updateImgObj2] = useState({
    img: images[2].img,
    id: images[2].id,
  });
  imgObjs.push(imgObj2);
  const [imgObj3, updateImgObj3] = useState({
    img: images[3].img,
    id: images[3].id,
  });
  imgObjs.push(imgObj3);
  const [imgObj4, updateImgObj4] = useState({
    img: images[4].img,
    id: images[4].id,
  });
  imgObjs.push(imgObj4);
  const [imgObj5, updateImgObj5] = useState({
    img: images[5].img,
    id: images[5].id,
  });
  imgObjs.push(imgObj5);
  const [imgObj6, updateImgObj6] = useState({
    img: images[6].img,
    id: images[6].id,
  });
  imgObjs.push(imgObj6);
  const [imgObj7, updateImgObj7] = useState({
    img: images[7].img,
    id: images[7].id,
  });
  imgObjs.push(imgObj7);
  const [imgObj8, updateImgObj8] = useState({
    img: images[8].img,
    id: images[8].id,
  });
